...
// OBTENER UN PRODUCTO CON ID Y PROVEEDORES
...
// OBTENER STOCK BAJO DE PRODUCTOS
...
// PRODUCTOS PROXIMOS A VENCER, POR LOTES EN 30 DÍAS
...
router.get('/alertas/caducados', async (req, res) => {
    try {
        const [productos] = await pool.query(`
            SELECT p.prodid, p.prodcodigo, p.prodnombre, 
                   c.catnombre AS categoria_nombre,
                   l.lotid, l.lotnro_lote, l.lotfecha_vencimiento, l.lotcantidad_actual,
